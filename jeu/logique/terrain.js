...
Jeu.Terrain = (function () {
  ...
  const CASES = { air: 0, herbe: 1, terre: 2, planche: 3 };
  const NOMS = ["air", "herbe", "terre", "planche"];
  const SOLIDES = [false, true, true, true]; // peut-on marcher dessus / se cogner dedans ?
  ...
  return { CASES, NOMS, creer, lireCase, estSolide, fabriquerTroncon, nombreDeCases };
})();
